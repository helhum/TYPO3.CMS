...
class Typo3DbBackend implements BackendInterface, \TYPO3\CMS\Core\SingletonInterface
{
    ...
    protected function getFrontendConstraintStatement($tableName, $ignoreEnableFields, array $enableFieldsToBeIgnored = array(), $includeDeleted)
    {
        ...
        if ($ignoreEnableFields && !$includeDeleted) {
            ...
            throw new \TYPO3\CMS\Extbase\Persistence\Generic\Exception\InconsistentQuerySettingsException('Query setting "ignoreEnableFields=FALSE" can not be used together with "includeDeleted=TRUE" in frontend context.', 1460975940);
        }
        return $statement;
    }
